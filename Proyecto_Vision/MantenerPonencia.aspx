<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MantenerPonencia.aspx.vb" Inherits="Proyecto_Vision.MantenerPonencia" %>
                ...
                <section class="grid_12"> 
                        ...
                        <div>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT cod_exp_pon, cod_eve_pon, fech_ini_pon, fech_fin_pon, nom_pon, desc_pon, tipo_pon, dirigido_a_pon, est_pon, id_amb_pon, id_pon, id_req_pon FROM ponencia">
                            </asp:SqlDataSource>
